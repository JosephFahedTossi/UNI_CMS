...
<div class="wrapper">
	...
	<header><h1>REGISTER AS PROFESSOR</h1>
	</header>
	<br>
	<br>
...
<section class="columns">
	...
	<div class="column">
		...
		<select name="specialty" id="specialty" value="choose">
		   ...
		   <option value="Business Administation">Business Administation</option>
		</select>
		</tr>
		
			<tr>	
			<td><input class="normal-sec" type="email" name="email" placeholder="Email"></td>
			</tr>
